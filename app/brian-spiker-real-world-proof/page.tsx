...
export const metadata = buildMetadata({
  ...
  description:
    'The receipts. Brian Spiker has run Spiker Carpet and Tile Care since 2013. 13 years of trucks, customers, payroll, weather, and bad days. The foundation under every Apex Flow Publishing House book.',
