...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Apex Flow Publishing House — a war-manual library across 12 series.',
    template: '%s | Apex Flow Publishing House',
  },
  description:
    'A war-manual library across 12 series, releasing book by book. Built on 13 years of operations at Spiker Carpet and Tile Care. Not therapist-speak — operator-grade self-help.',
