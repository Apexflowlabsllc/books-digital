...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    body: [
      ...
      "Do this for one goal today. Don't overhaul your whole life's worth of vague intentions in one sitting — that's just another version of productive procrastination, dressed up as thoroughness. Pick the one that's been bothering you the most, write the number down, and let today be the first day it's possible to actually lose.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "You don't beat this by having more willpower reserve at the finish line. You beat it by recognizing the four-second flicker for what it is the moment it shows up, instead of three years later when you're doing the math on what it actually cost.",
    ],
  },
  {
    ...
    body: [
      ...
      "The plateau will still feel peaceful while you do it. That's fine. You're not trying to make it feel uncomfortable — you're trying to make it move again. The feeling was never a reliable narrator here. The number is.",
    ],
  },
];
