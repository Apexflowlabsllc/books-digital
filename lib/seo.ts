...
const DEFAULT_DESCRIPTION =
  'A war-manual library across 12 series, releasing book by book — new titles added as they’re finished. Written by Brian Spiker — founder of Spiker Carpet and Tile Care, operating since 2013 (13 years).';
...
const BRIAN_PERSON = {
  ...
  description:
    'Founder of Spiker Carpet and Tile Care (operating since 2013, 13 years). Author of Apex Flow Publishing House (an expanding library across 12 series). Founder of Apex Flow Labs.',
  worksFor: [
    {
      '@type': 'Organization',
